...
<section class="padding-top">
	...
	<?php if (isset($current_field->is_locked) and $current_field->is_locked == 'yes'): ?>
		<div class="alert margin no-margin-top"><?php echo lang('streams:editing_locked_field'); ?></div>
	<?php endif; ?>
	...
	<fieldset>
		<ul>
			...
			<li class="row-fluid input-row">
				<label class="span3" for="field_name"><?php echo lang('streams:label.field_name');?> <span>*</span></label>
			...
			<li class="row-fluid input-row">
				<label class="span3" for="field_slug"><?php echo lang('streams:label.field_slug');?> <span>*</span><br /><small><?php echo lang('global:slug_instructions'); ?></small></label>
				<div class="input span9"><?php echo form_input('field_slug', $field->field_slug, 'maxlength="60" id="field_slug"'); ?></div>
			</li>
			...
			<li class="row-fluid input-row">
				<label class="span3" for="is_required"><?php echo lang('streams:label.field_required');?></label>
				<div class="input span9"><?php echo form_checkbox('is_required', 'yes', $is_required, 'id="is_required"');?></div>
			</li>
			...
			<li class="row-fluid input-row">
				<label class="span3" for="is_unique"><?php echo lang('streams:label.field_unique');?></label>
				<div class="input span9"><?php echo form_checkbox('is_unique', 'yes', $is_unique, 'id="is_unique"'); ?></div>
			</li>
			...
			<li class="row-fluid input-row">
				<label class="span3" for="field_instructions"><?php echo lang('streams:label.field_instructions');?><br /><small><?php echo lang('streams:instr.field_instructions');?></small></label>
				<div class="input span9"><?php echo form_textarea('instructions', $field->instructions, 'id="field_instructions"');?></div>
			</li>
			...
			<li class="row-fluid input-row">
				...
				<div class="inputs span9"><?php echo form_checkbox('title_column', 'yes', $title_column_status, 'id="title_column"');?></div>
			</li>
			<?php endif; ?>
			...
			<li class="row-fluid input-row">
				<label class="span3" for="field_type"><?php echo lang('streams:label.field_type'); ?> <span>*</span></label>
				<div class="input span9"><?php echo form_dropdown('field_type', $field_types, $field->field_type, 'data-placeholder="'.lang('streams:choose_a_field_type').'" id="field_type"'); ?></div>
			</li>
				...
				foreach( $current_type->custom_parameters as $param ):
					...
					if (method_exists($current_type, 'param_'.$param))
					{
						...
						if (is_array($input))
						{
							...
							$data['instructions']	= isset($input['instructions']) ? $input['instructions'] : null;
						}
						else
						{
							$data['input'] 			= $input;
