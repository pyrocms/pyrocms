...
<div class="alert alert-dismissable alert-danger animated-zing bounceIn">
...
<div class="alert alert-dismissable alert-warning animated-zing bounceIn">
	<button type="button" class="close" data-dismiss="alert">×</button>
...
<div class="alert alert-dismissable alert-success animated-zing bounceIn">
	<button type="button" class="close" data-dismiss="alert">×</button>
