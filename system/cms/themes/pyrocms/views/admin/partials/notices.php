...
<div class="alert alert-dismissable alert-danger animated-zing bounceIn margin-top margin-bottom">
...
<div class="alert alert-dismissable alert-success animated-zing bounceIn margin-top margin-bottom">
	<button type="button" class="close" data-dismiss="alert">×</button>
