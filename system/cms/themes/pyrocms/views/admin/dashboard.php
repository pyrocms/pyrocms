...
<div id="sortable">
	...
	<div class="one_half last">
		...
		<section id="quick_links" class="item <?php echo isset($rss_items); ?>">
			<ul>
				<?php if((array_key_exists('comments', $this->permissions) OR $this->current_user->group == 'admin') AND $this->module_m->enabled('comments')): ?>
				<li>
				...
				<?php if((array_key_exists('pages', $this->permissions) OR $this->current_user->group == 'admin') AND $this->module_m->enabled('pages')): ?>
				<li>
				...
				<?php if((array_key_exists('files', $this->permissions) OR $this->current_user->group == 'admin') AND $this->module_m->enabled('files')): ?>
				<li>
