<div id="details-container">
	...
	<?php else: ?>
		<div class="hidden" id="title-value-<?php echo $navigation_link->navigation_group_id ?>">
			<?php echo sprintf(lang('nav:link_edit_title'), $navigation_link->title);?>
		</div>
	<?php endif ?>
...
<?php endif ?>
			...
			<li class="<?php echo alternator('', 'even') ?>">
				...
				<span class="spacer-right">
					<?php echo form_radio('link_type', 'url', $navigation_link->link_type == 'url') ?> <?php echo lang('nav:url_label');?>
					<?php echo form_radio('link_type', 'uri', $navigation_link->link_type == 'uri') ?> <?php echo lang('nav:uri_label');?>
					<?php echo form_radio('link_type', 'module', $navigation_link->link_type == 'module') ?> <?php echo lang('nav:module_label');?>
					<?php echo form_radio('link_type', 'page', $navigation_link->link_type == 'page') ?> <?php echo lang('nav:page_label');?>
				</span>
			</li>
			...
			<li class="<?php echo alternator('', 'even') ?>">
				...
				<div id="navigation-module" style="<?php echo @$navigation_link->link_type == 'module' ? '' : 'display:none' ?>">
					...
					<?php echo form_dropdown('module_name', array(lang('nav:link_module_select_default'))+$modules_select, $navigation_link->module_name) ?>
				</div>
			...
			<li class="<?php echo alternator('', 'even') ?>">
				...
				<?php echo form_dropdown('target', array(''=> lang('nav:link_target_self'), '_blank' => lang('nav:link_target_blank')), $navigation_link->target) ?>
			</li>
