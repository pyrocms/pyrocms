...
<?php endif; ?>
			...
			<li class="<?php echo alternator('', 'even'); ?>">
				<label for="title"><?php echo lang('nav_title_label');?></label><br>
			...
			<?php if ($this->method == 'edit'): ?>
				<li class="<?php echo alternator('', 'even'); ?>">
					<label for="navigation_group_id"><?php echo lang('nav_group_label');?></label><br>
			...
			<li class="<?php echo alternator('', 'even'); ?>">
				<label for="link_type"><?php echo lang('nav_type_label');?></label><br>
			...
			<li class="<?php echo alternator('', 'even'); ?>">
				...
				<div id="navigation-url" style="<?php echo @$navigation_link->link_type == 'url' ? '' : 'display:none'; ?>">
					<label for="url"><?php echo lang('nav_url_label');?></label><br>
				...
				<div id="navigation-module" style="<?php echo @$navigation_link->link_type == 'module' ? '' : 'display:none'; ?>">
					<label for="module_name"><?php echo lang('nav_module_label');?></label><br>
				...
				<div id="navigation-uri" style="<?php echo @$navigation_link->link_type == 'uri' ? '' : 'display:none'; ?>">
					<label for="uri"><?php echo lang('nav_uri_label');?></label><br>
				...
				<div id="navigation-page" style="<?php echo @$navigation_link->link_type == 'page' ? '' : 'display:none'; ?>">
					<label for="page_id"><?php echo lang('nav_page_label');?></label><br>
					<select name="page_id">
			...
			<li class="<?php echo alternator('', 'even'); ?>">
				<label for="target"><?php echo lang('nav_target_label'); ?></label><br>
