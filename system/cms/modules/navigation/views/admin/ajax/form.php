...
<?php endif ?>
			...
			<li class="row-fluid input-row">
				...
				<div id="navigation-url" style="<?php echo @$link->link_type == 'url' ? '' : 'display:none' ?>">
					<label class="span3" for="url"><?php echo lang('nav:url_label');?></label>
					<div class="input span9">
				...
				<div id="navigation-module" style="<?php echo @$link->link_type == 'module' ? '' : 'display:none' ?>">
					<label class="span3" for="module_name"><?php echo lang('nav:module_label');?></label>
					<div class="input span9">
				...
				<div id="navigation-uri" style="<?php echo @$link->link_type == 'uri' ? '' : 'display:none' ?>">
					<label class="span3" for="uri"><?php echo lang('nav:uri_label');?></label>
					<div class="input span9">
				...
				<div id="navigation-page" style="<?php echo @$link->link_type == 'page' ? '' : 'display:none' ?>">
					<label class="span3" for="page_id"><?php echo lang('nav:page_label');?></label>
					<div class="input span9">
						<select name="page_id">
