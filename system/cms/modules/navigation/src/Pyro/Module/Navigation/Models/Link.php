<?php namespace Pyro\Module\Navigation\Models;

use Pyro\Models\Eloquent;
use Pyro\Module\Navigation\Models\Group;
...
class Link extends Eloquent
{
    ...
    {
        return $this->hasMany('Pyro\Module\Navigation\Models\Link', 'parent');
    }
    ...
    {
        return $this->belongsTo('Pyro\Module\Pages\Models\Page');
    }
