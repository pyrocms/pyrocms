...
<<<<<<< HEAD
$lang['user:profile_delete_failure']   = 'Il y a eu un problème lors de la suppression du champ de profil utilisateur';
...
$lang['user:profile_user_basic_data_label'] = 'Données basiques';
$lang['user:profile_company']               = 'Entreprise';
$lang['user:profile_updated_on']            = 'Mis à jour le';
...
$lang['user:register_step1']  = '<strong>Etape 1&nbsp;:</strong> Enregistrement';
...
$lang['user:list_title']      = 'Utilisateurs';
...
$lang['user:activate_label']         = 'Activer';
...
$lang['user:no_inactives'] = 'Il n\'y a aucun utilisateur actif.';
$lang['user:no_registred'] = 'Il n\'y a aucun utilisateur enregistré.';

$lang['account_changes_saved'] = 'Les modifications apportées à votre compte ont été sauvegardées avec succès.';

$lang['indicates_required'] = 'Indiquez les champs obligatoires';
...
$lang['user:error_username'] = 'Le nom d\'utilisateur que vous avez saisi est déjà utilisé';
$lang['user:error_email']    = 'L\'adresse email que vous avez saisi est déjà utilisée';
...
$lang['user:added_not_activated_success'] = 'Un nouvel utilisateur a été créé. Son compte doit être activé.';
...
$lang['user:activate_error']   = 'Vous devez d\'abord sélectionner un utilisateur.';
...
$lang['user:mass_delete_error']   = 'Vous devez d\'abord sélectionner des utilisateurs.';
...
$lang['user:register_error']     = 'Nous pensons que vous êtes un robot. Si nous faisons erreur, merci d\'accepter nos excuses.';
$lang['user:register_reasons']   = 'Abonnez-vous pour accéder aux espaces réservés. Vos paramètres seront enregistrés, plus de contenu et moins de publicité, etc.';

// Activation
$lang['user:activation_incorrect'] = 'L\'activation n\'a pas pu aboutir. Merci de renvoyer vos informations en vous assurant que les MAJUSCULES (CAPS LOCK) ne sont pas actives.';
$lang['user:activated_message']    = 'Votre compte a été activé, vous pouvez maintenant vous y connecter.';

// Login
$lang['user:logged_in']         = 'Vous êtes connecté(e).';
$lang['user:already_logged_in'] = 'Vous êtes déjà connecté(e). Merci de vous déconnecter avant de ré-essayer.';
$lang['user:login_incorrect']   = 'L\'email ou le mot de passe sont erronés. Merci de vérifier votre login en vous assurant que les MAJUSCULES (CAPS LOCK) ne sont pas actives.';
$lang['user:inactive']          = 'Le compte auquel vous tentez d\'accéder est inactif.<br />Vérifiez vos mails concernant l\'activation de votre compte - <em>il est peut être dans les spams</em>.';

// Logged Out
$lang['user:logged_out'] = 'Vous avez été déconnecté(e).';

// Forgot Pass
$lang['user:forgot_incorrect'] = 'Aucun compte correspondant à ces données n\'a été trouvé.';

$lang['user:password_reset_message'] = 'Votre mot de passe a été ré-initialisé. Vous devriez recevoir un e-mail dans les deux prochaines heures. Dans le cas contraire, il se trouve peut être malencontreusement dans les spams.';

// Emails ----------------------------------------------------------------------------------------------------

// Activation
$lang['user:activation_email_subject'] = 'Activation requise';
$lang['user:activation_email_body']    = 'Merci d\'avoir activé votre compte chez %s. Pour vous connecter au site, veuillez cliquer sur le lien ci-dessous:';

$lang['user:activated_email_subject']       = 'Activation réussie';
$lang['user:activated_email_content_line1'] = 'Merci de vous être enregistré(e) à %s. Avant de pouvoir activer votre compte, veuillez suivre entièrement le processus d\'enregistrement en cliquant sur le lien suivant :';
...
$lang['user:reset_pass_email_body']    = 'Votre mot de passe à %s a été ré-initialisé. Si vous n\'avez pas demandé ce changement, veuillez envoyer un e-mail à %s et nous résoudrons le problème rapidement.';
...
$lang['profile_registred_on_label'] = 'Enregistré(e) sur';
...
=======
$lang['user:profile_of_title'] = 'Profil de %s';

$lang['user:profile_user_details_label'] = 'Détails utilisateur';
$lang['user:profile_role_label']         = 'Rôle';
$lang['user:profile_registred_on_label'] = 'Enregistré sur';
$lang['user:profile_last_login_label']   = 'Dernière connexion';
$lang['user:profile_male_label']         = 'Homme';
$lang['user:profile_female_label']       = 'Femme';
$lang['user:profile_fields_label']  = 'Champs de Profil';
>>>>>>> 78fc6eb0f3fa4bce6a882b1dbd2bf21aefd4f44c

$lang['user:profile_not_set_up'] = 'Cet utilisateur n\'a pas de profil configuré.';

$lang['user:profile_edit'] = 'Modifier votre profil';

$lang['user:profile_personal_section'] = 'Privé';
...
=======
$lang['user:profile_display_name']  = 'Nom Affiché';
$lang['user:profile_dob']           = 'Date de naissance';
$lang['user:profile_dob_day']       = 'Jour';
$lang['user:profile_dob_month']     = 'Mois';
$lang['user:profile_dob_year']      = 'Année';
$lang['user:profile_gender']        = 'Civilité';
$lang['user:profile_gender_nt']     = 'Non spécifié';
$lang['user:profile_gender_male']   = 'Masculin';
$lang['user:profile_gender_female'] = 'Féminin';
$lang['user:profile_bio']           = 'A mon sujet';
>>>>>>> 78fc6eb0f3fa4bce6a882b1dbd2bf21aefd4f44c

$lang['user:profile_contact_section'] = 'Contact';

$lang['user:profile_phone']            = 'Téléphone';
$lang['user:profile_mobile']           = 'Mobile';
$lang['user:profile_address']          = 'Adresse';
$lang['user:profile_address_line1']    = 'Ligne 1';
$lang['user:profile_address_line2']    = 'Ligne 2';
$lang['user:profile_address_line3']    = 'Village/Ville';
$lang['user:profile_address_postcode'] = 'Code Postal';
$lang['user:profile_website']          = 'Site Internet';

$lang['user:profile_api_section'] = 'Accès API';

<<<<<<< HEAD
$lang['profile_edit_success'] = 'Votre profil a bien été sauvegardé.';
$lang['profile_edit_error']   = 'Une erreur a eu lieu.';
=======
$lang['user:profile_edit_success'] = 'Votre profil à bien été sauvegardé.';
$lang['user:profile_edit_error']   = 'Une erreur à eu lieu.';
>>>>>>> 78fc6eb0f3fa4bce6a882b1dbd2bf21aefd4f44c

// -- Buttons ------------------------------------------------------------------------------------------------

$lang['user:profile_save_btn'] = 'Enregistrer votre profil';
