...
$lang['user_error_email']              		= 'Podany adres e-mail jest już w użyciu';
...
$lang['user_reset_instructions']		= 'Wpisz swój adres e-mail lub nazwę użytkownika';
...
$lang['user_mass_delete_success'] 		= '%s z %s użytkowników usunięto pomyślnie.';
...
$lang['user_register_error']			= 'Uważamy że jesteś botem. Jeśli jest inaczej, przyjmij nasze przeprosiny.';
$lang['user_register_reasons'] 			= 'Dołącz do nas, aby uzyskać dostęp do treści zarezerwowanych tylko dla zarejestrowanych użytkowników.';
...
$lang['user_activated_message']   		= 'Twoje konto zostało aktywowane, możesz teraz się zalogować.';
...
$lang['user_reset_pass_email_body'] 		= 'Twoje hasło na stronie %s zostało zresetowane. Jeśli nie żądałeś zmiany hasła, skontaktuj się z nami wysyłąc email na adres %s, a postaramy się rozwiązać problem.';
