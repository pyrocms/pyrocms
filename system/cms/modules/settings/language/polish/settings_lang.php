...
#section settings
$lang['settings_site_name']					= 'Nazwa serwisu';
$lang['settings_site_name_desc']				= 'Nazwa serwisu dla tytułów stron oraz do użytku w serwisie.';

$lang['settings_site_slogan']					= 'Slogan serwisu';
$lang['settings_site_slogan_desc']				= 'Slogan serwisu dla tytułów stron oraz do użytku w serwisie.';

$lang['settings_site_lang']					= 'Język serwisu';
$lang['settings_site_lang_desc']				= 'Natywny język serwisu, używany przy wyborze skórki powiadomień e-mail, formularza kontaktowego oraz innych funkcji niezależnych od języka użytkownika.';
...
$lang['settings_frontend_enabled_desc'] 			= 'Opcja ta pozwala na włączanie i wyłączanie strony dla zwykłych użytkowników i gości. Przydatna opcja m.in. podczas prowadzenia prac konserwacyjnych lub wprowadzania usprawnień w serwisie.';
...
$lang['settings_ga_tracking_desc']				= 'Podaj swój kod śledzenia Google Analytics aby aktywować śledzenie odsłon serwisu. Przykład: UA-19483569-6';
...
$lang['settings_site_public_lang']				= 'Publiczne języki';
$lang['settings_site_public_lang_desc']				= 'Jakie języki będą oferowane wszystkim odwiedzającym Twój serwis?';

$lang['settings_admin_force_https']				= 'Wymuszać HTTPS dla Panelu administratora?';
$lang['settings_admin_force_https_desc']			= 'Pozwalać jedynie na bezpieczny protokół HTTPS podczas używania Panelu administratora?';

$lang['settings_files_cache']					= 'Pamięć cache dla plików';
$lang['settings_files_cache_desc']				= 'Kiedy wyświetlane są zdjęcia przez serwis.com/files, jaki powinien być czas trwania pamięci cache?';

$lang['settings_auto_username']					= 'Automatyczna nazwa użytkownika';
$lang['settings_auto_username_desc']				= 'Twórz nazwę użytkownika automatycznie, umożliwiając pominięcie jej podczas rejestracji.';

$lang['settings_registered_email']				= 'E-mail po rejestracji';
$lang['settings_registered_email_desc']				= 'Wyślij e-mail z powiadomieniem na adres kontaktowy kiedy ktoś się zarejestruje.';
...
$lang['settings_section_files']					= 'Pliki';
...
// messages
$lang['settings_no_settings']					= 'Aktualnie nie ma żadnych ustawień.';
