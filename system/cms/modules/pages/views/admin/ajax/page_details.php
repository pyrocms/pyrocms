...
<div class="buttons">
    ...
    ?>
    <?php echo anchor('admin/pages/duplicate/'.$page->id, lang('pages:duplicate_label'), 'class="btn btn-sm btn-warning"') ?>
    <?php echo anchor('admin/pages/edit/'.$page->id, lang('global:edit'), 'class="btn btn-sm btn-warning"') ?>
