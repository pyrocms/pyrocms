		...
		<div class="tabs">
			...
			<div class="form_inputs" id="page-meta">
				...
				<ul>
					...
					<li>
						<label for="meta_description"><?php echo lang('pages:meta_desc_label') ?></label> <div id="counter"></div>
						<?php echo form_textarea(array('name' => 'meta_description', 'value' => $page->meta_description, 'rows' => 5, 'id' => 'meta_description')) ?>
					</li>
				</ul>
				<style type="text/css">
					.alert_meta{
				...
				<script  type="text/javascript">
				    $(document).ready(function() {
				        $("#meta_description").limit({
				            limit: 100,
				            id_result: "counter",
				            alertClass: "alert_meta"
				            });
				         });
				</script>
				</fieldset>
