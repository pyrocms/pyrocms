<?php namespace Pyro\Module\Pages\Models;

use Pyro\Models\Eloquent;
use Pyro\Models\Collection;
...
class Page extends Eloquent
{
    ...
    {
        return $this->belongsTo('Pyro\Module\Pages\Models\PageType');
    }
    ...
    {
        return $this->belongsTo('Pyro\Module\Pages\Models\Page', 'parent_id');
    }
    ...
    {
        return $this->hasMany('Pyro\Module\Pages\Models\Page', 'parent_id');
    }
