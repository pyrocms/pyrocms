...
<strong>Επίσης πρέπει να πάτε στο Σχεδιασμός -> Πλοήγηση και να δημιουργήσετε έναν νέο σύνδεσμο πλοήγησης αν θέλετε να εμφανίζεται στο μενού.</strong></p>
...
<h6>Επιλογές</h6>
<p>Σας επιτρέπει να ενεργοποιήσετε τα σχόλια και να παράγετε τροφοδοσία RSS για αυτήν την σελίδα.
...
<h6>Αναθεωρήσεις</h6>
<p>Οι Αναθεωρήσεις είναι μια πολύ δυνατή λειτουργία για την επεξεργασία μιας υπάρχουσας σελίδας. 
Ας υποθέσουμε ότι ένας υπάλληλος κάνει μια σελίδα μαντάρα κατά την επεξεργασία της.
Απλώς επιλέγετε την ημερομηνία στην οποία θα θέλατε επιστρέψετε την σελίδα και πατήστε Αποθήκευση! 
Μπορείτε ακόμη να δείτε τις διαφορές μεταξύ των αναθεωρήσεων κάποιας σελίδας.</p>
...
Πλέον μπορείτε να εφαρμόσετε κανόνες CSS στο class \"my-twitter-widget\" στην καρτέλα CSS.</p>";