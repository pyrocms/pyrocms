			...
			<table class="table-list" border="0">
				...
				<tbody>
					...
					<tr class="<?php echo alternator('', 'alt'); ?>">
						<td class="image"><img class="pyro-image" src="<?php echo base_url($image->location === 'local' ? 'files/thumb/'.$image->id.'/50/50' : 'files/cloud_thumb/'.$image->id); ?>" alt="<?php echo $image->name; ?>" width="50" onclick="javascript:insertImage('<?php echo $image->id."', '".htmlentities($image->alt_attribute)."', '".$image->location."', '".$image->path; ?>');" /></td>
