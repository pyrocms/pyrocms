...
<?php if (!empty($files)): ?>
	...
	<ul>
	    ...
	    <li class="file">
		    ...
		    <p class="image">
			<img class="pyro-image" src="<?php echo base_url() . UPLOAD_PATH . 'files/' . $file->filename; ?>" alt="<?php echo $file->name; ?>" width="200" onclick="insertImage('<?php echo $file->id; ?>', '<?php echo htmlentities($file->name); ?>');" />
		    </p>
