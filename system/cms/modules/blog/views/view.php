...
<div class="post">
	...
	<div class="meta">
		...
		<div class="author">
			...
			<span><a href="{{ url:base }}user/{{ created_by:user_id }}">{{ created_by:display_name }}</a></span>
		</div>

		{{ if category }}
		<div class="category">
			{{ helper:lang line="blog:category_label" }}
			<span><a href="{{ url:base }}blog/category/{{ category:slug }}">{{ category:title }}</a></span>
		</div>
		{{ endif }}
		...
		<div class="keywords">
			{{ keywords }}
				<span><a href="{{ url:base }}blog/tagged/{{ keyword }}">{{ keyword }}</a></span>
			{{ /keywords }}
		</div>
		{{ endif }}
