	...
	<section class="box">
		...
		<section class="box-content">
			...
			<ul class="nav nav-tabs padded no-padding-bottom grayLightest-bg">
				...
				<li class="active">
					<a href="#blog-content-tab" data-toggle="tab"><span><?php echo lang('blog:content_label') ?></span></a>
				</li>

				<?php if ($stream_fields): ?>
				<li>
					<a href="#blog-custom-fields" data-toggle="tab"><span><?php echo lang('global:custom_fields') ?></span></a>
				</li>
				<?php endif; ?>

				<li>
					<a href="#blog-options-tab" data-toggle="tab"><span><?php echo lang('blog:options_label') ?></span></a>
				</li>
