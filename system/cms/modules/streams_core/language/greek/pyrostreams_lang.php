...
$lang['streams:save_entry_error']						= "Υπήρξε κάποιο πρόβλημα κατά την προσθήκη αυτής της εγγραφής.";
$lang['streams:save_entry_success']						= "Η εγγραφή προστέθηκε με επιτυχία.";
