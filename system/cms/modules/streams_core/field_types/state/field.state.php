...
class Field_state
{
	...
	public $custom_parameters		= array('state_display', 'default_state','country');
	...
	public function form_output($data, $entry_id, $field)
	{
		...
		if( ! isset($data['custom']['country']) ){ //Default : US
		...
		return form_dropdown($data['form_slug'], $this->states($field->is_required, $data['custom']['state_display'], $data['custom']['country']), $value, 'id="'.$data['form_slug'].'"');
	}
	...
	/**
	 * Select the country you want. if nothing is defined, it will be US by default
	 *
	 * @access	public
	 * @return	string
	 */	
	...
	{	
		...
		//Array Merge sucks with numeric value in key. Don't use it
