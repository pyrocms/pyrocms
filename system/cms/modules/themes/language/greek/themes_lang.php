...
$lang['themes.extract_error']		= 'Δεν ήταν δυνατό να εξαχθεί το θέμα.';
$lang['themes.upload_success']		= 'Το Template Μεταφορτώθηκε Με Επιτυχία.';
$lang['themes.default_delete_error']	= 'Δεν μπορείτε να διαγράψετε το προεπιλεγμένο θέμα.';
$lang['themes.delete_error']		= 'Δεν ήταν δυνατή η διαγραφή του φακέλου "%s".';
$lang['themes.mass_delete_success']	= '%s από τα %s θέματα διαγράφηκαν με επιτυχία.';
...
$lang['themes.list_title']		= 'Λίστα θεμάτων';
