...
$lang['help_body'] = "
<h4>Γενικά</h4><hr>
<p>Το πρόσθετο Αρχεία παρέχει άριστη διαχείριση των αρχείων που χρησιμοποιούντε στον ιστότοπο. 
...
Για να επεξεργαστείτε έναν φάκελο, επιλέξτε Διαχείριση Φακέλων στην αριστερή στήλη και μετά κάντε κλικ στο Επεξεργασία στον αντίστοιχο φάκελο που θέλετε να τροποιήσετε.</p>

<h6>Διαχείριση Αρχείων</h6>
<p>Για να διαχείριστείτε αρχεία επιλέξτε το όνομα του φακέλου στην αριστερή στήλη. Αν το αρχείο βρίσκεται σε κάποιον υποφάκελο απλά επιλέξτε τον φάκελο που ανήκει.
Εφόσον βρίσκεσται στον φάκελο αυτό, μπορείτε να επιλέξετε τον υποφάκελο και να φιλτράρετε κατά τύπο αρχείου με τα αναδυόμενα μενού στην πάνω μεριά της οθόνης.
Εφόσον βρίσκεσται στον επιθυμητό φάκελο μπορείτε να ανεβάσετε αρχεία πατώντας το κουμπί Ανέβασμα δίπλα από το πεδίο Φίλτρων. 
...
<p>Αφότου κάνετε κλικ στο κουμπί Ανέβασμα ενώ βρίσκεστε στον επιθυμιτό φάκελο, θα δείτε ένα διάλογο για το ανέβασμα αρχείων. 
...
Για να τακτοποιήσετε αυτόν τον περιορισμό μπορείτε είτε να ζητήσετε από τον host σας να σας αλλάξει το όριο για το ανέβασμα των αρχείων ή απλως να μικρύνεται τις εικόνες σας προτού τις ανεβάσετε. 
