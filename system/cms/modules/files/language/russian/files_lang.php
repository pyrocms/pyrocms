...
$lang['files.create_error']								= 'Во время создания файла произошла ошибка.';
$lang['files.edit_success']								= 'Файл сохранён.';
$lang['files.edit_error']									= 'Во время сохранения файла произошла ошибка.';
$lang['files.delete_success']							= 'Файл удалён.';
$lang['files.delete_error']								= 'Невозможно удалить файл.';
$lang['files.mass_delete_success']				= '%d из %d файлов успешно удалено, это были "%s и %s"';
$lang['files.mass_delete_error']					= 'Во время удаления %d из %d файлов, это были "%s и %s".';
$lang['files.upload_error']								= 'Файл должен быть загружен.';
$lang['files.invalid_extension']					= 'У файла должно быть правильное расширение.';
...
$lang['files.no_select_error']						= 'Сначала вы должны выбрать файл, запрос был прерван.';
...
$lang['file_folders.edit_title']					= 'Редактирование папки "%s"';
...
$lang['file_folders.create_error']				= 'Во время создания папки произошла ошибка.';
$lang['file_folders.edit_success']				= 'Папка сохранена.';
$lang['file_folders.edit_error']				= 'Во время сохранения папки произошла ошибка.';
$lang['file_folders.confirm_delete']			= 'Вы уверены, что хотите удалить выбранные папки, включая все файлы и вложенные папки внутри?';
$lang['file_folders.delete_mass_success']		= '%d из %d папок успешно удалено, это были "%s и %s.';
$lang['file_folders.delete_mass_error']			= 'Во время удаления %d из %d папок, это были "%s и %s"';
$lang['file_folders.delete_success']			= 'Папка "%s" удалена.';
$lang['file_folders.delete_error']				= 'Во время удаления папки "%s" произошла ошибка.';
