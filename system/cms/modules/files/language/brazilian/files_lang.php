...
$lang['files:added']						= 'Adicionado em';
$lang['files:width']						= 'Largura';
$lang['files:height']						= 'Altura';
$lang['files:ratio']						= 'Proporção';
$lang['files:alt_attribute']				= 'Texto alternativo';
$lang['files:full_size']					= 'Tamanho total';
$lang['files:filename']						= 'Nome do arquivo';
$lang['files:filesize']						= 'Tamanho do arquivo';
$lang['files:download_count']				= 'Transferências';
$lang['files:download']						= 'Transferir';
$lang['files:location']						= 'Localização';
$lang['files:keywords']						= 'Palavras-chave';
$lang['files:toggle_data_display']			= 'Alternar exibição de dados';
...
$lang['files:alt_saved']					= 'O texto alternativo da imagem foi salvo';
...
$lang['files:replace_warning']				= 'Atenção: não substitua um arquivo por outro de tipo diferente (ex. .jpg por .png)'; #translate
