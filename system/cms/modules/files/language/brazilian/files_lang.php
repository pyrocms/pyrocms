...
$lang['files:fetch_completed']				= 'Completo';
...
$lang['files:ratio']						= 'Proporção';
$lang['files:full_size']					= 'Tamanho total';
$lang['files:filename']						= 'Nome Arquivo';
$lang['files:filesize']						= 'Tamanho Arquivo';
...
$lang['files:no_folders']					= 'Os arquivos e pastas são gerenciados de maneira muito semelhante como em sua área de trabalho. Clique com o botão direito do mouse na área abaixo desta mensagem para criar a sua primeira pasta. Em seguida, clique com o botão direito sobre a pasta para renomear, apagar e fazer upload de arquivos, ou alterar detalhes como vinculá-la a um local numa Nuvem.';
$lang['files:no_folders_places']			= 'As pastas que você criar vão aparecer aqui numa árvore que pode ser expandida e reduzida. Clique em "Locais" para exibir a pasta raiz.';
...
$lang['files:folder_not_empty']				= 'Você deve excluir o conteúdo de "%s" primeiro';
$lang['files:mkdir_error']					= 'Nós somos incapazes de criar %s. Você deve criá-la manualmente';
...
$lang['files:specify_valid_folder']			= 'Você deve especificar uma pasta válida para fazer o upload do arquivo para';
$lang['files:enable_cdn']					= 'Você deve ativar o CDN para "%s" através de seu painel de controlo Rackspace antes de podermos sincronizar';
$lang['files:synchronization_started']		= 'Iniciando Sincronização';
