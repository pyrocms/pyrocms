...
// Titles
$lang['files.files_title']					= 'Meus arquivos';
$lang['files.upload_title']					= 'Envio de arquivo';
...
$lang['files.display_grid']					= 'Grade';
$lang['files.display_list']					= 'Lista';

// Messages
$lang['files.create_success']				= 'O arquivo foi salvo com sucesso.';
$lang['files.create_error']					= 'Ocorreu um erro ao tentar salvar o arquivo.';
$lang['files.edit_success']					= 'O arquivo foi salvo com sucesso.';
$lang['files.edit_error']					= 'Ocorreu um erro ao tentar salvar o arquivo.';
$lang['files.delete_success']				= 'O arquivo "%s" foi removida com êxito.';
$lang['files.delete_error']					= 'Ocorreu um erro ao tentar remover o arquivo "%s".';
$lang['files.mass_delete_success']			= '%d de %d arquivos foram removidas com êxito, foram eles "%s e %s".';
$lang['files.mass_delete_error']			= 'Ocorreu um erro ao tentar remover %d de %d arquivos, são eles "%s e %s".';
$lang['files.upload_error']					= 'O arquivo não foi enviado.';
$lang['files.invalid_extension']			= 'O arquivo deve ter uma extenção válida.';
$lang['files.not_exists']					= 'Um arquivo inválido foi selecionada.';
$lang['files.no_files']						= 'Não existem arquivos atualmente.';
$lang['files.no_permissions']				= 'Você não tem permissição para acessar o módulo Arquivos.';
$lang['files.no_select_error'] 				= 'Você precisa selecionar um arquivo primeiro, sua solicitação foi interrompida..';
...
$lang['file_folders.edit_title']			= 'Editando a pasta "%s"';
