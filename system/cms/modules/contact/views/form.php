...
<?php echo form_open(current_url(), 'id="contact-form"');?>
	...
	<p>
		...
		<?php echo form_input('contact_name', $form_values->contact_name, 'id="contact_name" class="contact-name"');?>
	</p>
	<p>
		<label for="contact_email"><?php echo lang('contact_email_label');?></label>
		<?php echo form_input('contact_email', $form_values->contact_email, 'id="contact_email" class="contact-email"');?>
	</p>
	<p>
		<label for="company_name"><?php echo lang('contact_company_name_label');?></label>
		<?php echo form_input('company_name', $form_values->company_name, 'id="company_name" class="company-name"');?>
	</p>
	<p>
		<label for="subject"><?php echo lang('contact_subject_label');?></label>
		<?php echo form_dropdown('subject', $subjects, $form_values->subject, 'id="subject" class="subject"'); ?>
		<input id="other_subject" name="other_subject" type="text" />
	</p>
	<p>
		<label for="message"><?php echo lang('contact_message_label'); ?></label>
		<?php echo form_textarea('message', $form_values->message, 'id="message" class="message"'); ?>
	</p>
