...
$lang['redirects.edit_title'] 			= 'Modifica Reindirizzo';
...
$lang['redirects.mass_delete_error'] 	= 'C\' è stato un errore nell\' eliminare il reindirizzo "%s".';
$lang['redirects.mass_delete_success']	= '%s reindirizzi su %s eliminati con successo.';
$lang['redirects.no_select_error'] 		= 'Devi selezionare almeno un reindirizzo da eliminare.';
$lang['redirects.request_conflict_error']	= 'Esiste già un reindirizzo per "%s".';