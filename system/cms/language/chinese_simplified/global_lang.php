...
$lang['global:profile']					= '个人资料'; #'Profile'

$lang['global:title'] 					= '标题'; 		//'Title';
$lang['name_label'] 					= '名称'; 		//'Name';
$lang['desc_label'] 					= '说明'; 		//'Description';
$lang['version_label'] 					= '版本'; 		//'Version';
$lang['global:author'] 					= '作者'; 		//'Author';
$lang['global:action'] 					= '操作'; 		//'Action';
$lang['global:slug'] 					= '代名';       //#'Slug';
$lang['global:slug_instructions']		= '只能是小写字母和下划线'; #'Lowercase characters and underscores only.';
$lang['dialog.delete_message'] 			= '确定要刪除吗？这将无法还原。'; //'Are you sure you want to delete this? It can not be undone.';
...
$lang['logged_in_welcome']				= '欢迎您 %s，您已经登入了。'; //'Welcome %s, you are logged in.';
$lang['logout_label'] 					= '登出'; 			//'Log out';
$lang['edit_profile_label'] 			= '编辑個人简介'; 	//'Edit Profile';
$lang['settings_label'] 				= '设定'; 			//'Settings';

$lang['close_message'] 					= '关闭此讯息'; 		//'Close this message';
$lang['general_error_label'] 			= '错误'; 			//'Error';
$lang['required_error_label'] 			= '缺少必要栏位'; 	//'Required field missing';
...
$lang['global:demo_restrictions']       = '在演示此页面时，一些特性将会被关闭'; // 'Some features on this page have been disabled for the demo.'; #translate
...
$lang['all_right_reserved']				= '保留所有相关权益'; // 'All Rights Reserved.';  #translate
$lang['powered_by_pyrocms']				= 'PyroCMS拥有'; // 'Powered by PyroCMS';  #translate
$lang['top_page']						= '顶部'; // 'Top';  #translate
$lang['back_to_top']					= '返回顶部'; // 'Back to Top';  #translate

$lang['global:image'] 					= '图片'; // 'Image'; #translate
