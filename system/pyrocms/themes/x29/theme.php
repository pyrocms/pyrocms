...
class Theme_X29 extends Theme {

    public $name			= 'X29 - An Admin Theme';
    public $author			= 'Jerel Unruh';
    public $author_website	= 'http://unruhdesigns.com/';
    public $website			= 'http://pyrocms.com/';
    public $description		= 'An Admin theme with a horizontal dropdown menu, full width content, and CSS3 styling.';
    public $version			= '1.0';
	public $type			= 'admin';
