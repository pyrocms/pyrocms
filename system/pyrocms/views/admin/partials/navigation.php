<nav id="main-nav">
	...
	<ul>
		...
		<li><a href="#" class="top-link <?php echo ($this->module_data AND $this->module_data['menu'] == 'content') ? 'current' : ''; ?>">Content</a>
			<ul>
				<?php
		...
		<li><a href="#" class="top-link <?php echo ($this->module_data AND $this->module_data['menu'] == 'design') ? 'current' : ''; ?>">Design</a>
			<ul>
				<?php
		...
		<li>
			<a href="#" class="top-link <?php echo (($this->module_data AND $this->module_data['menu'] == 'users') OR $this->module == 'users') ? 'current' : ''; ?>">Users</a>
			<ul>
