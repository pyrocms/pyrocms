<div id="upload-box">
	<h2><?php echo lang('files.upload_title'); ?><span class="close ui-icon ui-icon-closethick">Close</span></h2>
	...
	<p>
		<?php echo form_dropdown('folder_id', $folders_tree); ?>
	</p>
	<p>
...
<div id="files_browser">
	...
	<div id="files_right_pane">
		...
		<?php if ($active_folder): ?>
			...
			<div id="files_toolbar">
				<ul>
					<li>
						...
						<?php echo form_dropdown('parent_id', $folders_tree, $active_folder->id, 'id="parent_id" title="image"'); ?>
					</li>
				</ul>
			</div>    
			<div id="radio-group">
			...
			<?php endif; ?>
		<?php else: ?>	
			<p><?php echo lang('file_folders.no_folders'); ?><?php echo anchor('admin/files/folders/create', lang('file_folders.create_title'), 'class="button"'); ?></p>
		<?php endif; ?>
		</div>
	</div>
</div>