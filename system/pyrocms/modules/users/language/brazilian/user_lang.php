...
$lang['user_register_step1'] 			= '<strong>Passo 1:</strong> Registro';
...
$lang['user_registred_title'] 			= 'Usuários Registrados';

// labels
$lang['user_edit_title'] 				= 'Editar usuário "%s"';
...
$lang['user_reset_password_title'] 		= 'Reiniciar Senha';
$lang['user_password_reset_title'] 		= 'Reinício de Senha';  
...
$lang['user_last_name'] 				= 'Último Name';
...
$lang['user_activation_code_sent_notice']	= 'Um email foi enviado com o seu código de ativação.';
...
$lang['user_reset_pass_btn'] 			= 'Reiniciar Senha';
...
// Create
$lang['user_added_and_activated_success'] 		= 'Novo usuário foi criado e ativado.';
$lang['user_added_not_activated_success'] 		= 'Novo usuário foi cariado, porém, esta conta precisa ser ativada.';
...
// Delete
$lang['user_delete_self_error'] 				= 'Você não pode deletar você mesmo!';
$lang['user_mass_delete_success'] 				= '%s usuários de %s foram deletados com sucesso.';
$lang['user_mass_delete_error'] 				= 'Você precisa selecionar os usuários primeiro.';

// Register
$lang['user_email_pass_missing'] 				= 'O campo de Email ou Senha não foram preenchidos.';
...
// Activation
$lang['user_activation_incorrect']   			= 'Ativação falhou. Por favor, verifique seus detalhes e tenha certeza de não estar com o CAPS LOCK ( CAIXA ALTA ) ativo.';
...
$lang['user_password_reset_message']   			= "Sua senha foi reiniciada. Você deverá receber um email em nas próximas 2 . Se você não receber, verifique se o mesmo não está na sua pasta de lixo eletrônico por acidente.";

// Emails ----------------------------------------------------------------------------------------------------

// Activation
$lang['user_activation_email_subject'] 			= 'Ativação Requerida';
...
$lang['user_activated_email_content_line1'] 	= 'Obrigado por se registrar em %s. Agora você pode concluir a ativação de sua conta terminando o processo de registro clicando no seguinte link:';
$lang['user_activated_email_content_line2'] 	= 'No caso de seu programa de email não reconhecer o link como deveria, por favor, copie e cole a seguinte URL e entre o seu código de ativação:';
