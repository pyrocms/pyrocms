	...
	public function install()
	{
		...
		$default_settings = "
			INSERT INTO `settings` (`slug`, `title`, `description`, `type`, `default`, `value`, `options`, `is_required`, `is_gui`, `module`, `order`) VALUES
			 ...
			 ('default_theme','Default Theme','Select the theme you want users to see by default.','default','default','','get_themes','1','0','','0'),
			 ('admin_theme','Admin Theme','Select the theme for the admin panel.','','admin_theme','admin_theme','get_themes','1','0','','0'),
