	...
	public function info()
	{
		return array(
			...
			'description' => array(
				...
				'lt' => 'Leidžia administratoriams keisti puslapio pavadinimą, žinutes, administratoriaus el. pašta ir kitą.'
			),
			'frontend' => FALSE,
			'backend'  => TRUE,
			'menu'	  => FALSE
	...
	public function install()
	{
		...
		$default_settings = "
			INSERT INTO `settings` (`slug`, `title`, `description`, `type`, `default`, `value`, `options`, `is_required`, `is_gui`, `module`) VALUES
			 ...
			 ('site_lang','Site Language','The native language of the website, used to choose templates of e-mail internal notifications and receiving visitors contact and other features that should not bend the language of a user.','text','en','".CURRENT_LANGUAGE."','','1','1',''),
			 ...
			 ('require_lastname','Require last names?','For some situations, a last name may not be required. Do you want to force users to enter one or not?','radio','1','','1=Required|0=Optional','1','1','users'),
