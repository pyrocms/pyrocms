<div id="comments_container">
	...
	<?php $comments = $this->comments_m->get_by_module_item($module, $module_id);
	if (!empty($comments)): ?>
		<ul id="comment_list">
...
<?php echo gravatar($comment->email, 40); ?>
			<p class="comment_heading" id="<?php echo $comment->id; ?>"><strong><?php echo anchor($comment->website, $comment->name); ?></strong></p>
