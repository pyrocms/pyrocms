(function($) {
	...
	$(function() {
		...
		$('#page-list li a').live('click', function()
		{
			...
			$('div#page-details').load(BASE_URL + 'admin/pages/ajax_page_details/' + page_id);
			return false;
		});
		...
		var update_tree = function() {
			...
			{
				// Load the details box in
				$('div#page-details').load(BASE_URL + 'admin/pages/ajax_page_details/' + $('#page-details #page-id').val());				
			}
		}
		update_tree();
		...
		$('ol.sortable').nestedSortable({
			...
			stop: function(event, ui) {
				...
				$.post(BASE_URL + 'admin/pages/order', { 'order': order, 'root_pages': root_pages } );
			}
		});
	});
