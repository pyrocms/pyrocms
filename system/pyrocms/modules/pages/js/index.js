(function($) {
	...
	$(function() {
		...
		var update_tree = function() {
			...
			{
				// Load the details box in
				$('div#page-details').load(BASE_URI + 'admin/pages/ajax_page_details/' + $('#page-details #page-id').val());				
			}
		}
		update_tree();
		...
		$('ol.sortable').nestedSortable({
			...
			stop: function(event, ui) {
				...
				$.post(BASE_URI + 'admin/pages/order', { 'order': order, 'root_pages': root_pages } );
			}
		});
	});
