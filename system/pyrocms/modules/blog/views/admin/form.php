...
<?php else: ?>
		<h3><?php echo sprintf(lang('blog_edit_title'), $article->title); ?></h3>
<?php endif; ?>
	...
	<div id="blog-content-tab">
		<ol>
			...
			<li>
				...
				<?php echo form_dropdown('status', array('draft' => lang('blog_draft_label'), 'live' => lang('blog_live_label')), $article->status) ?>
			</li>
			<li class="even">
	...
	<div id="blog-options-tab">
		<ol>
			<li>
				...
				<?php echo form_dropdown('category_id', array(lang('blog_no_category_select_label')) + $categories, @$article->category_id) ?>
			...
			<li class="even date-meta">
				...
				<div style="float:left;">
					<?php echo form_input('created_on', date('Y-m-d', $article->created_on), 'maxlength="10" id="datepicker" class="text width-20"'); ?>
				</div>
				<label class="time-meta"><?php echo lang('blog_time_label'); ?></label>
				<?php echo form_dropdown('created_on_hour', $hours, date('H', $article->created_on)) ?>
