...
class Rss extends Public_Controller
{
	...
	function index()
	{
		$posts = $this->cache->model('blog_m', 'get_many_by', array(array(
			'status' => 'live',
	...
	function _build_feed( $posts = array() )
	{
		...
		$this->data->rss->page_description = sprintf($this->lang->line('blog_rss_articles_title'), $this->settings->item('site_name'));
