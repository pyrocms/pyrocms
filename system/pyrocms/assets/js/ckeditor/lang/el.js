...
CKEDITOR.lang['el'] =
{
	...
	// ARIA descriptions.
	toolbar	: 'Μπάρα εργαλείων', // MISSING
	editor	: 'Επεργαστής πλούσιου κειμένου', // MISSING
	...
	common :
	{
		...
		validateNumberFailed : 'Αυτή η τιμή δεν είναι αριθμόςThis value is not a number.', 
		confirmNewPage	: 'Οι όποιες μη αποθηκευμένες αλλαγές σε αυτό το περιεχόμενο θα χαθούν. Είσαστε σίγουροι ότι θέλετε να φορτώσετε μια νέα σελίδα;',
		confirmCancel	: 'Κάποιες από τις επιλογές έχουν τροποποιηθεί. Είσαστε σίγουροι ότι θέλετε να κλείσετε το παράθυρο;',
		options			: 'Επιλογές',
		target			: 'Προορισμός',
		targetNew		: 'Νέο παράθυρο (_blank)',
		targetTop		: 'Μητρικό παράθυρο (_top)',
		targetSelf		: 'Ίδιο παράθυρο (_self)',
		targetParent	: 'Παράθυρο γονέας (_parent)',
		langDirLTR		: 'Αριστερά στα Δεξιά (LTR)',
		langDirRTL		: 'Δεξιά στα Αριστερά (RTL)',
		styles			: 'Στυλ',
		...
		alignMiddle		: 'Μέση',
		alignBottom		: 'Κάτω',
		invalidHeight	: 'Τα ύψη πρέπει να είναι ένας αριθμός.',
		invalidWidth	: 'Τα πλάτη πρέπει να είναι ένας αριθμός.',
	...
	contextmenu :
	{
		options : 'Επιλογές Μενου Δεξιού Κλικ'
	},
	...
	specialChar		:
	{
		...
		options : 'Επιλογές Ειδικών Συμβόλων'
	},

	// Link dialog.
	link :
	{
		toolbar		: 'Εισαγωγή/Μεταβολή Συνδέσμου',
		other 		: '<άλλος>',
		menu		: 'Μεταβολή Συνδέσμου',
		title		: 'Σύνδεσμος',
		info		: 'Σύνδεσμος',
		target		: 'Παράθυρο Προορισμού (Target)',
		upload		: 'Αποστολή',
		...
		popupResizable	: 'Προσαρμόσιμες διαστάσεις',
		popupStatusBar	: 'Μπάρα Κατάστασης',
		popupLocationBar: 'Μπάρα Τοποθεσίας',
		popupToolbar	: 'Μπάρα Εργαλείων',
		popupMenuBar	: 'Μπάρα Μενού',
		popupFullScreen	: 'Πλήρης Οθόνη',
		...
		langDirLTR		: 'Αριστερά προς Δεξιά (LTR)',
		langDirRTL		: 'Δεξιά προς Αριστερά (RTL)',
		acccessKey		: 'Συντόμευση Πληκτρολογίου',
		name			: 'Όνομα',
		...
		charset			: 'Κωδικοποίηση Χαρακτήρων Συνδεδεμένης Resource',
		styles			: 'Στύλ',
		rel			: 'Σχέση', // MISSING
		selectAnchor		: 'Επιλέξτε μια άγκυρα',
		anchorName		: 'Βάσει του Ονόματος (Name) της άγκυρας',
		anchorId			: 'Βάσει Id του στοιχείου',
		...
		noEmail			: 'Εισάγετε την διεύθυνση email'
	},
	...
	findAndReplace :
	{
		title				: 'Αναζήτηση και Αντικατάσταση', // MISSING
		find				: 'Αναζήτηση',
		...
		replaceSuccessMsg	: 'Αντικαταστάθηκαν %1 περίπτωση/εις.' // MISSING
	},
	...
	table :
	{
		...
		widthPx		: 'pixels',
		widthPc		: '%',
		widthUnit	: 'μονάδα πλάτους', // MISSING
		cellSpace	: 'Απόσταση κελιών',
		cellPad		: 'Γέμισμα κελιών',
		caption		: 'Υπέρτιτλος',
		summary		: 'Περίληψη',
		headers		: 'Κεφαλίδες', // MISSING
		headersNone		: 'Καμία', // MISSING
		headersColumn	: 'Πρώτη στήλη', // MISSING
		headersRow		: 'Πρώτη γραμμή', // MISSING
		headersBoth		: 'Και τα δύο', // MISSING
