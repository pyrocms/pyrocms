...
$lang['imglib_source_image_required'] = "Especifique a imagem fonte nas suas configurações.";
$lang['imglib_gd_required'] = "Para o uso deste recurso, é necessária a biblioteca de imagens GD.";
...
$lang['imglib_copy_error'] = "Ocorreu um erro durante a tentativa de substituição do arquivo. Comfirme se há permissão de escrita para a pasta.";
$lang['imglib_rotate_unsupported'] = "Aparentemente, o servidor não tem suporte para rotação de imagens.";
$lang['imglib_libpath_invalid'] = "O caminho para a biblioteca de imagens não está correto. Defina o caminho correto nas configurações de imagem.";
$lang['imglib_image_process_failed'] = "Falha no processamento da imagem. Verifique se o servidor tem suporte para o protocolo escolhido e se o caminho para a sua biblioteca de imagens está correto.";
