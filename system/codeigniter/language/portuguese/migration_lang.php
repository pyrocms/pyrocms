...
$lang['migration_multiple_version']		= "Há migrações múltiplas com o mesmo número de versão: %d.";
...
$lang['migration_missing_down_method']	= "A classe de migração \"%s\" não possui o método 'up'.";
$lang['migration_invalid_filename']		= "A migração \"%s\" possui um nome do ficheiro inválido.";
