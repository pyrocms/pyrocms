...
$lang['intro_text']		= 	'Ebben a lépésben a telepítő azt ellenőrzi, hogy alkalmas-e egyáltalán a szerver környezete a PyroCMS futtatására. A legtöbb szerver számára nem okoz gondot a PyroCMS működtetése.';
...
$lang['server_fail']	=	'A megadott szerver nem támogatott, ezért a PyroCMS lehet hogy nem fog működni. Amíg a PHP és a MySQL naprakész, a PyroCMS számára nem okoz gondot, csupán a keresőbarát URL-ek hiányoznak majd';
...
$lang['summary_partial']=	'A szerver a <em>legtöbb</em> elvárásnak megfelelt, ami azt jelenti hogy a környezet ugyan alkalmas a PyroCMS futtatására, de nagy a valószínűsége, hogy problémák lépnek fel képátméretezésnél, illetve indexképek készítésénél.';
