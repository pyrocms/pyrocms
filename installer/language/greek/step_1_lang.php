...
$lang['db_text']		=	'Για να μπορέσει το πρόγραμμα εγκατάστασης την έκδοση του διακομιστή MySQL/SQLite σας απαιτείται η εισαγωγή του hostname, του ονόματος χρήστη και του κωδικού πρόσβασης στην παρακάτω φόρμα. Αυτές οι παραμέτροι θα χρησιμοποιηθούν και κατά την εγκατάσταση της βάσης δεδομένων.';
