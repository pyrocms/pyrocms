...
$lang['php_required']	=	'Το PyroCMS απαιτεί PHP εκδόσης 5.0 ή πιο πρόσφατη.';
$lang['php_version']	=	'Ο διακομιστής σας έχει την έκδοση';
$lang['php_fail']		=	'Η τρέχουσα έκδοση της PHP δεν υποστηρίζεται. Το PyroCMS απαιτεί PHP έκδοσης 5.0 ή πιο πρόσφατη για να μπορεί να δουλέψει κανονικά.';
...
$lang['zlib']			=	'Zlib';
$lang['zlib_required']	= 	'Το PyroCMS απαιτεί την Zlib για να μπορεί να αποσυμπιέζει και να εγκαθηστά τα θέματα.';
...
$lang['summary_success']	=	'Ο διακομιστής σας πληρεί τις απαιτήσεις για να μπορεί το PyroCMS να εκτελεστεί κανονικά, πηγαίνετε στο επόμενο βήμα κάνοντας κλικ παρακάτω.';
