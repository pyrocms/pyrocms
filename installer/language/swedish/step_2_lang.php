...
$lang['server_fail'] = 'PyroCMS har inte stöd för din servermjukvara och kommer inte att fungera. Men om PHP och MySQL installationerna är uppdaterade bör PyroCMS fungera korrekt. Doch utan stöd för enkla URL:er';
...
$lang['gd_fail'] = 'Vi kan inte bestämma version av GD biblioteket. Detta innebär vanligtvis att GD biblioteket inte är installerat. PyroCMS kommer fortfarande fungera korrekt, men en del av bildfunktionaliteten kanske inte fungerar. Vi rekommenderar att du aktiverar/installerar GD biblioteket.';
