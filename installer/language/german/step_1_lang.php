...
$lang['rewrite_fail']       = 'Du hast "(Apache mit mod_rewrite)" als HTTP-Server ausgew&auml;hlt. Jedoch kann die Installation nicht ausfindig machen, ob mod_rewrite auf dem Server installiert ist oder nicht. Wenden Sie sich an Ihren Anbieter oder fahren Sie auf eigene Risiken fort.';
$lang['mod_rewrite']        = 'Du hast "(Apache with mod_rewrite)" als HTTP-Server ausgew&auml;hlt. Jedoch ist auf deinem Server kein mod_rewrite aktiviert. Ask your host to enable it or install PyroCMS using the "Apache (without mod_rewrite)" option.';
