...
class Ajax extends CI_Controller {
	 ...
	 */
	private $languages	= array ('arabic', 'brazilian', 'english', 'dutch', 'french', 'finnish', 'german', 'polish', 'chinese_traditional', 'slovenian', 'spanish', 'russian', 'greek', 'lithuanian','danish','vietnamese', 'indonesian');
