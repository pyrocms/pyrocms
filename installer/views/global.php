				...
				<ul id="lang">
					...
					<li>
						<a href="<?php echo site_url('installer/change/brazilian'); ?>" title="Brazilian Portuguese">
							<img src="<?php echo base_url(); ?>assets/img/flags/br.gif" alt="Brazilian Portuguese" />
						</a>
					</li>
				    <li>
						<a href="<?php echo site_url('installer/change/portuguese'); ?>" title="Portuguese Portugal">
							<img src="<?php echo base_url(); ?>assets/img/flags/pt.gif" alt="Portuguese Portugal" />
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('installer/change/dutch'); ?>" title="Dutch">
							<img src="<?php echo base_url(); ?>assets/img/flags/nl.gif" alt="Dutch" />
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('installer/change/french'); ?>" title="French">
							<img src="<?php echo base_url(); ?>assets/img/flags/fr.gif" alt="French" />
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('installer/change/finnish'); ?>" title="Finnish">
							<img src="<?php echo base_url(); ?>assets/img/flags/fi.gif" alt="Finnish" />
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('installer/change/swedish'); ?>" title="Swedish">
							<img src="<?php echo base_url(); ?>assets/img/flags/se.gif" alt="Swedish" />
						</a>
					</li>
				        <li>
						<a href="<?php echo site_url('installer/change/polish'); ?>" title="Polish">
							<img src="<?php echo base_url(); ?>assets/img/flags/pl.gif" alt="Polish" />
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('installer/change/slovenian'); ?>" title="Slovensko">
							<img src="<?php echo base_url(); ?>assets/img/flags/si.gif" alt="Slovensko" />
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('installer/change/spanish'); ?>" title="Spanish">
							<img src="<?php echo base_url(); ?>assets/img/flags/es.gif" alt="Spànish" />
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('installer/change/chinese_traditional'); ?>" title="繁體中文">
							<img src="<?php echo base_url(); ?>assets/img/flags/tw.gif" alt="繁體中文" />
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('installer/change/russian'); ?>" title="Русский">
							<img src="<?php echo base_url(); ?>assets/img/flags/ru.gif" alt="Русский" />
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('installer/change/arabic'); ?>" title="العربية">
							<img src="<?php echo base_url(); ?>assets/img/flags/ar.gif" alt="العربية" />
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('installer/change/greek'); ?>" title="Ελληνικά">
							<img src="<?php echo base_url(); ?>assets/img/flags/el.gif" alt="Greek" />
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('installer/change/german'); ?>" title="German">
							<img src="<?php echo base_url(); ?>assets/img/flags/de.gif" alt="German" />
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('installer/change/lithuanian'); ?>" title="Lithuanian">
							<img src="<?php echo base_url(); ?>assets/img/flags/lt.gif" alt="Lithuanian" />
						</a>
					</li>
						<li>
						<a href="<?php echo site_url('installer/change/danish'); ?>" title="Danish">
							<img src="<?php echo base_url(); ?>assets/img/flags/dk.gif" alt="Danish" />
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('installer/change/vietnamese'); ?>" title="Tiếng Việt">
							<img src="<?php echo base_url(); ?>assets/img/flags/vn.gif" alt="Vietnamese" />
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('installer/change/indonesian'); ?>" title="Indonesian">
							<img src="<?php echo base_url(); ?>assets/img/flags/id.gif" alt="Indonesian" />
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('installer/change/hungarian'); ?>" title="Magyar">
							<img src="<?php echo base_url(); ?>assets/img/flags/hu.gif" alt="Magyar" />
						</a>
					</li>     
					<li>
						<a href="<?php echo site_url('installer/change/thai'); ?>" title="ไทย">
							<img src="<?php echo base_url(); ?>assets/img/flags/th.gif" alt="ไทย" />
						</a>
					</li> 	
				</ul>
			</div>		
