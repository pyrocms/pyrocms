<h2>Install PyroCMS</h2>
<p>Complete the form below and hit the button labelled "Install PyroCMS" to install PyroCMS. Be sure to install PyroCMS into the right database since all existing changes will be lost !</p>
<form id="install_frm" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
	...
	<p id="next_step"><input type="submit" id="submit" value="Install PyroCMS" /></p>
	<div class="clear" />
</form>