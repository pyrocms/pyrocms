...
class Admin extends Admin_Controller {
	...
	public function create()
	{
		...
		if ($this->form_validation->run())
		{
			...
			//check category restrictions just in case - could be callback on form validation I guess..?
	...
	public function edit($id = 0)
	{
		...
		if ($this->form_validation->run())
		{
			...
			//check category restrictions just in case - could be callback on form validation..?
			if (!empty($this->restrict_array) AND !in_array($this->input->post('category_id'), $this->restrict_array))
			{
			   show_error(lang('cp_access_denied'));
			}
