...
<?php echo form_open($this->uri->uri_string(), 'class="crud"'); ?>
	<ul>
		<li class="<?php echo alternator('', 'even'); ?>">
			...
			<a class="colorbox button" name="crop-button" href="<?php echo site_url('uploads/galleries/' . $gallery_image->slug . '/full/' . $gallery_image->filename . $gallery_image->extension); ?>"><?php echo lang('gallery_images.crop_label'); ?></a>
			<br />
			<br />
