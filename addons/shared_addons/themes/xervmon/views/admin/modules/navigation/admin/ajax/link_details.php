<div id="details-container">
	...
	<div class="buttons">
		<?php echo anchor('admin/navigation/edit/' . $link->id, lang('global:edit'), 'rel="'.$link->navigation_group_id.'" class="button ajax btn btn-primary"') ?>
		<?php echo anchor('admin/navigation/delete/' . $link->id, lang('global:delete'), 'class="confirm button btn btn-danger"') ?>
	</div>
</div>