		...
		<tbody>
			...
			<?php foreach ($users as $member): ?>
				<tr>
					...
					<td class="actions">
						<?php echo anchor('admin/users/edit/' . $member->id, lang('global:edit'), array('class'=>'button edit btn')) ?>
						<?php echo anchor('admin/users/delete/' . $member->id, lang('global:delete'), array('class'=>'confirm button delete btn btn-danger')) ?>
					</td>
				</tr>
			<?php endforeach ?>
		</tbody>
