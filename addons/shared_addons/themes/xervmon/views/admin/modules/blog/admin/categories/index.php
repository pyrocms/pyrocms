			...
			<tbody>
				...
				<tr>
					...
					<td class="align-center buttons buttons-small">
						<?php echo anchor('admin/blog/categories/edit/'.$category->id, lang('global:edit'), 'class="button edit btn"') ?>
						<?php echo anchor('admin/blog/categories/delete/'.$category->id, lang('global:delete'), 'class="confirm button delete btn btn-danger"') ;?>
					</td>
				</tr>
				<?php endforeach ?>
			</tbody>
