...
<div class="bs-docs-example">
	...
	<ul id="myTab" class="nav nav-tabs">
		<li  class="active"><a href="#blog-content-tab" data-toggle="tab"><span><?php echo lang('blog:content_label') ?></span></a></li>
		<li><a href="#blog-options-tab" data-toggle="tab"><span><?php echo lang('blog:options_label') ?></span></a></li>
	</ul>

	<!-- Content tab -->
        <div id="myTabContent" class="tab-content">
	<div class="tab-pane fade in active" id="blog-content-tab">
		<fieldset>
			<ul>
				<li >
	...
	<!-- Options tab -->
	<div class="tab-pane fade" id="blog-options-tab">
		<fieldset>
			<ul>
