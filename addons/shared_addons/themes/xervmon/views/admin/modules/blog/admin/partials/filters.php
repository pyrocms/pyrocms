	...
	<?php echo form_open('', '', array('f_module' => $module_details['slug'])) ?>
		<ul>
			...
			<li class="">
				...
				<?php echo form_input('f_keywords', '', 'style="width: 55%; margin-top: 3px;"') ?>
			</li>

			<li class="">
				<?php echo anchor(current_url() . '#', lang('buttons:cancel'), 'class="button red btn" style="margin-top:25px;"') ?>
			</li>
		</ul>
	<?php echo form_close() ?>
</fieldset>