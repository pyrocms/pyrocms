                    ...
                    <tbody>
                        <?php foreach ($variables as $variable): ?>
                            <tr>
                                ...
                                <td class="actions">
                                    <?php echo anchor('admin/variables/edit/' . $variable->id, lang('buttons:edit'), 'class="button edit btn"') ?>
                                    <?php echo anchor('admin/variables/delete/' . $variable->id, lang('buttons:delete'), array('class' => 'confirm button delete btn btn-ganger')) ?>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
