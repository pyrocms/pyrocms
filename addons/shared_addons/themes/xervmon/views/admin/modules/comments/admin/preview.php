<div id="comment-preview">
	...
	<div class="float-right spacer-right buttons buttons-small">
		<?php if ($comment->is_active): ?>
			<?php echo anchor('admin/comments/unapprove/'.$comment->id, lang('global:unapprove'), 'class="button btn"') ?>
		<?php else:?>
			<?php echo anchor('admin/comments/approve/'.$comment->id, lang('global:approve'), 'class="button btn btn-success"') ?>
		<?php endif?>
		<?php echo anchor('admin/comments/delete/'.$comment->id, lang('global:delete'), 'class="button btn btn-danger"')?>
	</div>
