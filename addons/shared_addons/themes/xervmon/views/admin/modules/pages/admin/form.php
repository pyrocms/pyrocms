...
<div class="bs-docs-example">
	...
	<ul id="myTab" class="nav nav-tabs">
	 ...
	 <div id="myTabContent" class="tab-content">
			...
			<div class="tab-pane fade in active" id="page-details">
			...
			<!-- Content tab -->
			<div class="tab-pane fade in " id="page-content">
			...
			<!-- Meta data tab -->
			<div class="tab-pane fade in " id="page-meta">
			...
			<!-- Design tab -->
			<div class="tab-pane fade in " id="page-design">
			...
			<!-- Script tab -->
			<div class="tab-pane fade in " id="page-script">
			...
			<!-- Options tab -->
			<div class="tab-pane fade in " id="page-options">
