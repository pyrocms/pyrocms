...
<div class="bs-docs-example">
	...
	<ul id="myTab" class="nav nav-tabs">
				...
				<div class="tab-pane fade in active" id="page-layout-basic">
				...
				<div class="tab-pane fade in" id="page-layout-layout">
				...
				<!-- Meta data tab -->
				<div class="tab-pane fade in" id="page-layout-meta">
				...
				<!-- Design tab -->
				<div class="tab-pane fade in" id="page-layout-css">
				...
				<!-- Script tab -->
				<div class="tab-pane fade in" id="page-layout-script">
