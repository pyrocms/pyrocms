...
class Admin extends Admin_Controller {
	...
	function categories()
	{
		...
		$grid = new DataGrid($data['pagetitle'], $this->forums_m->category_table);
		$grid->per_page = 20;
	...
	{  
		...
		$edit = new DataEdit($data['pagetitle'], $this->forums_m->category_table);
	...
	function forums()
	{
		...
		$grid->per_page = 20;
		$grid->db->from($this->forums_m->forum_table .' f');
		$grid->db->join($this->forums_m->category_table .' c', 'c.categoryID=f.categoryID', 'LEFT');
	...
	{  
		...
		$edit = new DataEdit($data['pagetitle'], $this->forums_m->forum_table);
		...
		foreach($this->forums_m->getCategories() as $cat):
