...
$lang['email_attachment_missing']		= "De volgende attachment kon niet worden gevonden: %s";
$lang['email_attachment_unredable']		= "De volgende attachment kon niet worden geopend: %s";
...
$lang['email_sent']						= "Uw bericht is succesvol verstuurd met behulp van het: %s protocol";
...
$lang['email_filed_smtp_login']			= "Het versturen van het AUTH LOGIN commando is mislukt. Foutmelding: %s";
...
/* Location: ./system/language/dutch/email_lang.php */