...
<ul>
	<?php if($this->news_m->get_many_by(array('limit' => $limit,'year' => $year))): ?>
	<?php foreach ($this->news_m->get_many_by(array('limit' => $limit,'year' => $archive)) as $news): ?>
	<li>
	...
	<?php endforeach; ?>
	<?php else: ?>
	<li>No articles are available for the selected year.</li>
	<?php endif; ?>
</ul>