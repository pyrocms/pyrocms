...
<ul>
	<?php if($this->news_m->get_many_by(array('limit' => $limit,'category' => $category))): ?>
	<?php foreach ($this->news_m->get_many_by(array('limit' => $limit,'category' => $category)) as $news): ?>
	<li>
	...
	<?php endforeach; ?>
	<?php else: ?>
	<li>No articles are available for the selected category.</li>
	<?php endif; ?>
</ul>