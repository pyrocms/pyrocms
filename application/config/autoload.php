...
$autoload['libraries'] = array('database', 'session', 'cache', 'layout', 'parser', 'settings/settings', 'widgets');
...
$autoload['helper'] = array('url', 'form', 'language', 'pages/pages', 'modules/module', 'themes/theme', 'asset', 'pagination', 'debug');
