...
LinkDialog.prototype.getImage = function(imageid, callback) {
	this.get(imageid, callback);
};

LinkDialog.prototype.downloadImage = function(imageid) {
...
LinkDialog.prototype.insertAndClose = function(image, width, height) {
...
LinkDialog.prototype.insertImage = function(thumbspan, image, width, height) {
	...
	if (win) {
		...
		if (win.LinkDialog) {
			(win.LinkDialog.getImageData) && (win.LinkDialog.getImageData());
			(win.LinkDialog.showPreviewImage) && (win.LinkDialog.showPreviewImage(url));
...
LinkDialog.prototype.insertResizeImage = function(){
	var self = this, 
...
LinkDialog.prototype.resizeImage = function(imageId, width, height, callback){
...
LinkDialog.prototype.insertThumbnail = function(anchor, imageId){
...
LinkDialog.prototype.showUploader = function(){
...
LinkDialog.prototype.loadUploader = function() {
	var self = this;
...
LinkDialog.prototype.loadResizer = function(filename, event) {
...
// show resizer image
LinkDialog.prototype.showResizeImage = function(image) {
	var
...
LinkDialog.prototype.showManager = function(anchor, image_id) {
	var self = this;
	// show spinner image
...
LinkDialog.prototype.assetUploaded = function(folder_id) {
	this.recache = true;
	var remove = [];
...
LinkDialog.prototype.deleteImage = function(imageid) {
