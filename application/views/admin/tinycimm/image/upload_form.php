...
<head>
	...
	//<![CDATA[
		...
		* - will create unqiue names for inputs and will not group them 
		**/
		Object.prototype.multiFileUpload = function(config){
			config = config || {allowedTypes:['<?=str_replace('|', "','", $upload_config['allowed_types']);?>']};
