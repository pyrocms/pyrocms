...
<script type="text/javascript">
	...
	tinyMCE.init({
		...
		theme_advanced_buttons2 : "cut,copy,paste,pastetext,pasteword,|,outdent,indent,|,bullist,numlist,|,sub,sup,|,link,unlink,|,image,tinycimm-image,media,|,forecolor,backcolor,|,preview,fullscreen,code,|,charmap,emotions,advhr,|,undo,redo",
