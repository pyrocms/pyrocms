<div id="addfolder" class="clearfix" style="display:none;">
	...
	<img src="img/save.gif" onClick="TinyCIMMMedia.addFolder('media');" style="cursor:pointer;float:left;opacity:0.65" onMouseOver="this.style.opacity='1';" onMouseOut="this.style.opacity='0.65';" alt="save folder" title="save folder" />
...
<table border="0" cellpadding="2" cellspacing="1">
	<tr><td>Files:</td><td><?=$selected_folder_info['total_assets'];?></td></tr>
	<tr><td>Size:</td><td><?=$selected_folder_info['total_file_size'];?></td></tr>
	<tr><td>View:</td><td>
	<select style="border:1px solid #AAA" onchange="TinyCIMMMedia.changeView(this.options[this.selectedIndex].value)">
