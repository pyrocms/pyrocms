...
*/
	 ...
	 * id not required.
	 **/
	$config['columns']             = array('first_name', 'last_name', 'company', 'phone', 'lang', 'bio', 'dob', 'gender', 'phone', 'mobile', 'address_line1', 'address_line2', 'address_line3', 'postcode', 'msn_handle', 'aim_handle', 'yim_handle', 'gtalk_handle', 'gravatar', 'updated_on', 'display_name', 'twitter_access_token', 'twitter_access_token_secret');
