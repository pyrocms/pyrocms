...
<?=form_open('comments/create/'.$module.'/'.$id); ?>
	...
	<div id="commentform">
		...
		<p>
			<label for="message"><?=lang('comments_message_label');?>:</label><br />
