	<ul>
		...
		<li><a href="<?php echo site_url('admin/media/audio'); ?>"><span><?php echo lang('media.audio.title'); ?></span></a></li>
		<li><a href="<?php echo site_url('admin/media/folders'); ?>"><span><?php echo lang('media.folders.manage_title'); ?></span></a></li>
	</ul>
